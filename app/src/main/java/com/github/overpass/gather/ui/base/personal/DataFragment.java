package com.github.overpass.gather.ui.base.personal;
...
import com.github.overpass.gather.ui.auth.register.add.AddDataStatus;
...
import static com.github.overpass.gather.commons.android.TextKt.text;
...
public abstract class DataFragment<VM extends DataViewModel>
    ...
    protected void onPermissionChanged(boolean denied) {
        if (denied) {
            snackbar(ivPhotoPreview, "Sorry, you can't choose photo without permissions", Snackbar.LENGTH_SHORT);
        }
    }
    ...
    public void onSubmitClick() {
        getViewModel().submit(getContext().getContentResolver(), text(tietUsername))
